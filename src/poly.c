         ...
         double corrXY)
{
  ...
  r1 = dist(x1, y1, cx, cy, sdX, sdY, corrXY);
  r2 = dist(x2, y2, cx, cy, sdX, sdY, corrXY);
  r12 = dist(x1, y1, x2, y2, sdX, sdY, corrXY);
  ...
  r0 = dist(x0, y0, cx, cy, sdX, sdY, corrXY);
         ...
         double corrXY)
{
  ...
  for (int j = 0; j < (*np - 1); j++)
      ...
      for( int i = 0; i < ndiv; i++)
	{
	  ...
	  sum += frint(func, funcpara, x1, y1, x2, y2, cx, cy, sdX, sdY, corrXY);
	}
    }
